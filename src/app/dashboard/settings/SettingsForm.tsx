  ...
  return (
    <form action={action} style={{ maxWidth: '42rem' }}>
      <Stack gap="xl">
        ...
        <Card withBorder radius="md" padding="xl">
          <Title order={3} mb="md">Payment Preferences</Title>
          <Stack gap="lg">
            {/* 
            ...
            {paymentMethod === 'DUITNOW' && (
              <Stack gap="sm">
                ...
                {duitNowType === 'ID' ? (
                  ...
                  <Box pl="md" style={{ borderLeft: '2px solid var(--mantine-color-blue-filled)' }}>
                    <Stack gap="sm">
                      <TextInput 
                        label="Bank Name"
                        name="bankName"
                      ...
                      <TextInput 
                        ...
                        defaultValue={profile.bankAccountName || profile.legalName || ''}
                        placeholder="John Doe"
                        required
                      />
                    </Stack>
